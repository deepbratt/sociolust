	...
	<div class="col-md-8">
	 ...
	 <div class="col-md-4" style="text-align:right;">
		<a href="" class="icon-item">
		  <div class="col-md-12">
				<div class="col-md-2"><a href="profile.php"><img src="uploads/26219167_1580311485385521_8938737836320191600_n.jpg" style="height:50px;border-radius:50%;padding:5px;"></a></div>
				<div class="dropdown">
				<a href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white;">
				  <div class="col-md-6" style="margin-top:15px;font-size:15px;">Shuvradeb M.  <i class="fa fa-caret-down"></i>
					<div class="dropdown-menu">
						<li><a href="profile.php" style="text-align:center;color:red;"><b>My Profile</b></a></li>
						<li><a href="javascript:void(0);" style="text-align:center;color:red;"><b>Settings</b></a></li>
